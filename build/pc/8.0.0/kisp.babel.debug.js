...
;(function (global, top, parent, window, document, location, navigator, localStorage, sessionStorage, console, history, setTimeout, setInterval, Array, Boolean, Date, Error, Function, JSON, Map, Math, Number, Object, RegExp, String, $, undefined) {
    ...
    var Module = function () {
        ...
        */
        ...
        Module.prototype = {
            ...
            */
            load: function load(name, container, fn) {
                //重载 load(name, fn);
    ...
    */
    define('KISP', function (_require, module, exports) {
        ...
        return (/**@lends KISP*/{
                ...
                */
                modules: ['Array', 'Date', 'String', 'Emitter', 'Object', 'Tree', 'Escape', 'Fn', 'Math', 'Hash', 'Query', 'JSON', 'Script', 'StyleSheet', 'Tasks', 'KISP', 'Defaults', 'Config', 'Data', 'Router', 'Proxy', 'Proxy.defaults', 'Url', 'Url.defaults', 'App', 'App.defaults', '$', 'Module', 'Module.defaults', 'View', 'View.defaults', 'Panel', 'Panel.defaults', 'Template', 'HTMLParser', 'RandomId', 'Package', 'Package.defaults', 'Loading', 'Loading.defaults', 'Style', 'Mask', 'Mask.defaults', 'Mask.config', 'Alert', 'Alert.defaults', 'Alert.config', 'Dialog', 'Dialog.defaults', 'Dialog.config', 'Mapper', 'Confirm', 'Confirm.defaults', 'API', 'API.defaults', 'SSH.API', 'SSH.API.defaults', 'SSH', 'SSH.defaults', 'SessionStorage', 'SessionStorage.defaults', 'Storage', 'LocalStorage', 'LocalStorage.defaults', 'MD5', 'Navigator', 'Navigator.defaults', 'Tabs', 'Tabs.defaults', 'Tabs.config', 'Toast', 'Toast.defaults'],
        ...
        return (/**@lends Defaults*/{
                ...
                */
                config: function config(name, value) {
                    ...
                    //set()
                    (_module$exports = module.exports).set.apply(_module$exports, arguments);
                }
            ...
            */
            get: function get() {
                ...
                var all = $Object.map(name$factory, function (name, factory) {
                    ...
                    if (typeof factory == 'function') {
                        factory = factory.apply(undefined, args);
                    }
        ...
        Template.prototype = {
            ...
            */
            fill: function fill(data) {
                for (var _len11 = arguments.length, params = Array(_len11 > 1 ? _len11 - 1 : 0), _key11 = 1; _key11 < _len11; _key11++) {
    ...
    */
    define('RandomId', function (require, module, exports) {
        ...
        return (/**@lends RandomId*/{
                ...
                */
                get: function get() {
                    for (var _len12 = arguments.length, list = Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
        ...
        return (/**@lends Style*/{
                ...
                */
                merge: function merge() {
                    for (var _len13 = arguments.length, items = Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
    ...
    define('Style/Pixel', function (require, module, exports) {
        ...
        */
        ...
        return {
            ...
            */
            normalize: function normalize(style, keys) {
                //重载 normalize(value);
            ...
            */
            parsePercent: function parsePercent(percent, total) {
    ...
    */
    define('Loading/Sample/iOS', ['<div id="{id}" class="KISP Loading-iOS {cssClass}" style="{style}">', '    <div class="Main">', '        <div class="Item-0"></div>', '        <div class="Item-1"></div>', '        <div class="Item-2"></div>', '        <div class="Item-3"></div>', '        <div class="Item-4"></div>', '        <div class="Item-5"></div>', '        <div class="Item-6"></div>', '        <div class="Item-7"></div>', '        <div class="Item-8"></div>', '        <div class="Item-9"></div>', '        <div class="Item-10"></div>', '        <div class="Item-11"></div>', '    </div>', '    <span id="{textId}" class="Text">{text}</span>', '</div>'].join('\n'));
