...
* name: weberp 
* version: 8.2.0
* build time: 2019-05-16 14:28:00
* concat md5: 5B9F6C628159580EE910CAB95B57CC0A
* source files: 128(126)
*    partial/begin.js
*    base/Module.js
...
;(function (global, top, parent, window, document, location, navigator, localStorage, sessionStorage, console, history, setTimeout, setInterval, Array, Boolean, Date, Error, Function, JSON, Map, Math, Number, Object, RegExp, String, $, undefined) {
        ...
        return (/**@lends KISP*/{
                ...
                */
                ...
                , /**
                  ...
                  */
                md5: '5B9F6C628159580EE910CAB95B57CC0A',
                ...
                */
                modules: ['Array', 'Date', 'String', 'Emitter', 'Object', 'Tree', 'Escape', 'Fn', 'Math', 'Hash', 'Query', 'JSON', 'Script', 'StyleSheet', 'Tasks', 'KISP', 'Defaults', 'Config', 'Data', 'Router', 'Proxy', 'Proxy.defaults', 'Url', 'Url.defaults', 'App', 'App.defaults', 'OuterModule', 'OuterModule.defaults', '$', 'Navigator', 'Navigator.defaults', 'SessionStorage', 'SessionStorage.defaults', 'Storage', 'CircularJSON', 'LocalStorage', 'LocalStorage.defaults', 'Package', 'Package.defaults', 'Loading', 'Loading.defaults', 'Style', 'RandomId', 'Mask', 'Mask.defaults', 'Session', 'Session.defaults', 'View', 'View.defaults', 'Panel', 'Panel.defaults', 'Template', 'HTMLParser', 'Mapper', 'Alert', 'Alert.defaults', 'Dialog', 'Dialog.defaults', 'Confirm', 'Confirm.defaults', 'API', 'API.defaults', 'SSH.API', 'SSH.API.defaults', 'SSH', 'SSH.defaults', 'MD5', 'Tabs', 'Tabs.defaults', 'Toast', 'Toast.defaults'],
    ...
    * Mask/Sample
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/ui/mask/Mask/Sample.html
    */
    ...
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/ui/dialog/Dialog/Template/Sample.html
    */
    ...
    * Alert/Sample
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/ui/alert/Alert/Sample.html
    */
    ...
    * Toast/Sample
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/ui/toast/Toast/Sample.html
    */
    ...
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/mobile/scroller/Scroller/pulldown/Pulldown/Indicator/Sample.html
    */
    ...
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/mobile/scroller/Scroller/pullup/Pullup/Indicator/Sample.html
    */
    ...
    * Loading/Sample/IOS
    * 由 kisp-packer 生成。 
    * 来源: ../build/weberp/8.2.0/src/ui/loading/Loading/Sample/IOS.html
    */
